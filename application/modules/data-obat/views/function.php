<script type="text/javascript" charset="utf-8" async defer>
  ...
  $('body').on('click', '.add', function(event) {
      ...
      $.ajax({
        url: '<?= site_url('data-obat/modal_add') ?>',
        type: 'post',
        dataType: 'html',
        beforeSend: function(){   
  ...
  $('body').on('click', '.edit', function(event) {
	  ...
	  /* Act on the event */
	    ...
	    $.ajax({
	      url: '<?= site_url('data-obat/modal_edit') ?>',
	      type: 'post',
	      dataType: 'html',
        data: {id: id,},
	      beforeSend: function(){   
  ...
  $('body').on('submit', '#perbarui', function(event) {
    ...
    $.ajax({
      url: '<?= site_url('data-obat/perbarui') ?>',
      type: 'post',
      dataType: 'html',
      data: new FormData(this),
      contentType: false,       
