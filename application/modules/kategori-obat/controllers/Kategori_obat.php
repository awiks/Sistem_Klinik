...
class Kategori_obat extends MY_Controller {
	...
	{
		parent ::__construct();
		$this->load->model('kategori_obat_model','k_model');
	}
	...
	public function index()
	{
		...
		$data['title_content'] = '<i class="fas fa-th"></i> '.ucfirst(str_replace('-', ' ',$this->uri->segment(1)));;
		...
		$this->load->view('kategori-obat/content',$data);

		$this->load->view('template/footer',$data);
		$this->load->view('template/modal');
		$this->load->view('template/js');
		$this->load->view('template/alert.php');
		$this->load->view('kategori-obat/function');
	...
	{
		$this->load->view('kategori-obat/modal_add');
	}
	...
	public function modal_edit()
	{
		...
		$this->load->view('kategori-obat/modal_edit',$data);
	}
	...
	{
		$this->load->view('kategori-obat/delete');
	}
