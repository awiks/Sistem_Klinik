...
<div aria-hidden="true" role="dialog" tabindex="-1" id="Modal-add" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-olive p-2">
...
<!-- START: POP-UP FOR ADD DATA LG -->
<div aria-hidden="true" role="dialog" tabindex="-1" id="Modal-lg" class="modal fade">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-olive p-2">
                <h4 class="modal-title title">Add data</h4>
               <button aria-hidden="true" data-dismiss="modal" class="close" type="button">&times;</button>
            </div>
            <div class="modal-body">
              <div class="load-lg" style="display:block;"><i class="fa fa-spinner fa-spin default"></i> Memuat...</div>
              <div class="modal-add-lg"></div> 
            </div>
        </div>
    </div>
</div>
<!-- END: POP-UP FOR ADD DATA LG -->